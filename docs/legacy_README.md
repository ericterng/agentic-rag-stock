...
> This file preserves the original README before the novelty-focused rewrite. For current implementation, follow `README.md`, `week3_progress.md`, and `model_ablation_plan.md`.
